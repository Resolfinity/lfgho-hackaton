...
export interface CounterTestInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "facilitatorManager",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_SetNumber",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "test_Increment",
    values?: undefined
  ): string;
...
export interface CounterTest extends BaseContract {
  connect(runner?: ContractRunner | null): CounterTest;
  ...
  facilitatorManager: TypedContractMethod<[], [string], "view">;
  ...
  testFuzz_SetNumber: TypedContractMethod<
    [x: BigNumberish],
    [void],
    "nonpayable"
  >;

  test_Increment: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "facilitatorManager"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "testFuzz_SetNumber"
  ): TypedContractMethod<[x: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_Increment"
  ): TypedContractMethod<[], [void], "nonpayable">;
