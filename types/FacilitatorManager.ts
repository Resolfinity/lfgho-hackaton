...
export interface FacilitatorManagerInterface extends Interface {
  getFunction(
...
export interface FacilitatorManager extends BaseContract {
  connect(runner?: ContractRunner | null): FacilitatorManager;
  waitForDeployment(): Promise<this>;

  interface: FacilitatorManagerInterface;
